...
uint256 hashGenesisBlock("0xf358c621fdb0414513613c91b99bb2423f7204b7661eae79db88a90c7426ef66");
...
bool LoadBlockIndex()
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0xf358c621fdb0414513613c91b99bb2423f7204b7661eae79db88a90c7426ef66");
    }
...
bool InitBlockIndex() {
    ...
    if (!fReindex) {
        // Genesis Block:
        // CBlock(hash=12a765e31ffd4059bada, PoW=0000050c34a64b415b6b, ver=1, hashPrevBlock=00000000000000000000, hashMerkleRoot=97ddfbbae6, nTime=1447266965, nBits=1e0ffff0, nNonce=0, vtx=1)
        ...
        // Genesis block
        const char* pszTimestamp = "France 9 novembre 2016 version 2 de blackdiamondcoin fondation";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        txNew.vin[0].scriptSig = CScript() << 486604799 << CBigNum(4) << vector<unsigned char>((const unsigned char*)pszTimestamp, (const unsigned char*)pszTimestamp + strlen(pszTimestamp));
        txNew.vout[0].nValue = 10000 * COIN;
        txNew.vout[0].scriptPubKey = CScript() << ParseHex("04f0b12c895665e4bfb124ad62d7f0e47ba97d3b65dc87fde5a4a668d102097af25541d93694fda705b88c60bd95feefee18baa80fe3c0cb46a0acc9ffd15bc334") << OP_CHECKSIG;
        CBlock block;
        block.vtx.push_back(txNew);
        block.hashPrevBlock = 0;
        block.hashMerkleRoot = block.BuildMerkleTree();
        block.nVersion = 1;
        block.nTime    = 1447266965;
        ...
        assert(block.hashMerkleRoot == uint256("0x276d0ee664c55a72abd527726cf9015032f8e88576ae761f73ab3e90f797ab60"));
...
unsigned char pchMessageStart[4] = { 0xfc, 0x60, 0x19, 0x09 }; // blackdiamondcoin: increase each by adding 2 to bitcoin's value.
